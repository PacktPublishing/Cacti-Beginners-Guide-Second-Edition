...
function cbEnhancedInfo_config_arrays() {
	...
	$menu['CactiBook Plugins']['plugins/cbEnhancedInfo/cbEnhancedInfo_listInformation.php'] = 'Enhanced Info';
	$menu['CactiBook Plugins']['plugins/cbEnhancedInfo/cbEnhancedInfo_listInformation.php'] = 'Enhanced Info2';
	
	 $menu2 = array ();
        foreach ($menu as $temp => $temp2 ) {
                $menu2[$temp] = $temp2;
                if ($temp == __('Management')) {
                        $menu2['CactiBook Plugins']['plugins/cbEnhancedInfo/cbEnhancedInfo_listInformation.php']        = 'Enhanced Info';
                }
        }
        $menu = $menu2;

        $menu_glyphs['CactiBook Plugins'] = 'fa fa-bullhorn';
}
