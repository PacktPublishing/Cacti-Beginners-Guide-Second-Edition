...
`C:\\rrdtool\\rrdtool.exe create $filename --start $startTime --step 300 DS:data:GAUGE:600:U:U RRA:AVERAGE:0.5:1:16 RRA:AVERAGE:0.5:4:16 RRA:AVERAGE:0.5:12:16 RRA:MAX:0.5:1:16 RRA:MAX:0.5:4:16 RRA:MAX:0.5:12:16 RRA:LAST:0.5:1:16 RRA:LAST:0.5:4:16 RRA:LAST:0.5:12:16`;
